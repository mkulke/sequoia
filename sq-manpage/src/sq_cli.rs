    ...
    let app = if !cfg!(feature = "net") {
        ...
        app.subcommand(
            SubCommand::with_name("keyserver")
                ...
                .subcommand(
                    SubCommand::with_name("send").about("Sends a key").arg(
                        Arg::with_name("input")
                            .value_name("FILE")
                            .help("Reads from FILE or stdin if omitted"),
                    ),
            ...
            SubCommand::with_name("wkd")
                ...
                .subcommand(
                    SubCommand::with_name("url")
                        .about(
                            "Prints the Web Key Directory URL of \
                                        an email address.",
                        )
                        .arg(
                            Arg::with_name("input")
                    ...
                    SubCommand::with_name("generate")
                        ...
                        .arg(
                            Arg::with_name("input")
                                ...
                                .help(
                                    "Adds certificates from CERT-RING to \
                                           the WKD",
                                ),
                        )
                        .arg(
                            Arg::with_name("direct_method")
                                .short("d")
                                .long("direct-method")
                                .help(
