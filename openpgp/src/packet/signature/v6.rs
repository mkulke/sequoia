...
///
///   [version 6]: https://tools.ietf.org/html/rfc4880#section-5.2
///   [`Signature`]: super::Signature
///
/// Note: Per RFC 4880, v6 signatures should not be generated, but
/// they should be accepted.  As such, support for version 6
